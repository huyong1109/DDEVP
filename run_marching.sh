...
setenv CASE 0
#setenv CASE _DBC
$MPICH_PATH/bin/mpif77 prep$CASE.f -L/usr/local/intel-cluster/mkl/lib/intel64/ -lmkl_intel_lp64 -lmkl_sequential -lmkl_core -lpthread -lmkl_lapack95_lp64 -lmkl_blacs_lp64
